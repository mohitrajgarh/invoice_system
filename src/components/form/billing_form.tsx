        ...
        <div className="mb-6 p-5 bg-white text-black rounded-2xl shadow border border-gray-200">
            ...
            focus:outline-none focus:ring-1 focus:ring-[#3ABBF9]/60 focus:border-[#3ABBF9]"
                    ...
                    <input
                        ...
                        className="w-32 p-3 border border-gray-300 rounded-xl 
            placeholder:text-gray-400
            focus:outline-none focus:ring-1 focus:ring-[#3ABBF9]/60 focus:border-[#3ABBF9]"
                    />
            ...
            <button
                onClick={() =>
                    setData({
                        ...
                        billing: {
                            ...data.billing,
                            items: [...data.billing.items, { service: "", amount: 0 }],
                        },
                    })
                }
                className="mt-4 w-full border border-dashed border-[#3ABBF9] text-[#3ABBF9] 
